   ...
   <div class="container-fluid text-center">  
	...
	<div class="col-sm-8 text-left" style="padding:5% 10%;"> 
                ...
                <tr>  
                    ...
                    <td colspan="3">
                    	<c:if test="${ !empty fdp.foodPOriginName }">
                        	<img src ="${ pageContext.servletContext.contextPath }/resources/upload_files/${fdp.foodPChangeName}" alt = "">
                        </c:if>
                        <c:if test="${ empty fdp.foodPOriginName }">
			...
			<c:if test="${ loginUser.userId eq fdp.foodPWriter }">
            	...
            	<div align = "center">
            	 <button class="btn btn-primary"><a href="blist.fo" >홈으로</a></button>
            	</div>
            <br><br>
