...
<jsp:include page="../common/header.jsp"/>
   <div class="container-fluid text-center">  
	...
	<div class="col-sm-8 text-left" style="padding:5% 10%;"> 
            ...
            <br>
            <div align = "center">
            	 <button class="btn btn-primary"><a href="list.fo" >홈으로</a></button>
            </div>
            <br><br>
                ...
                <tr>
                    ...
                    <td colspan="3">
                    	<c:if test="${ !empty fd.originName }">
                        	<a href="${ pageContext.servletContext.contextPath }/resources/upload_files/${fd.changeName}" download="${ fd.originName }">${ fd.originName }</a>
                        </c:if>
                        <c:if test="${ empty fd.originName }">
                        	첨부파일이 없습니다.
                        </c:if>
