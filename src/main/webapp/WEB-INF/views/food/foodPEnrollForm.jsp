...
<body id="page-top" >
	...
	<br>      
            ...
            <form id="enrollForm" method="post" action="insertP.fo" enctype="multipart/form-data">
                <table align="center">
                     <div class="form-group">
                        <label for="title">제목</label>
                        <input type="text" id="ftitle" class="form-control" name="foodPTitle" required>
                    </div>
                     <div class="form-group">
                        <label for="writer">작성자</label>
                        <input type="text" id="fwriter" class="form-control" value="${ loginUser.userId }" name="foodPWriter" readonly>
                    </div>
                    <div class="form-group">
              		...
              		<div class="form-group">
                		...
                		<textarea class="form-control" id="foodPContent" name = "foodPContent"></textarea>
            		</div>      
				...
				CKEDITOR.replace('foodPContent',{
            		height: 500,
            	    filebrowserUploadUrl: '${pageContext.request.contextPath}/ckeditor/upload.ck?function=8'
            		});
