...
<div class="container-fluid text-center">  
	...
	<div class="col-sm-8 text-left" style="padding:5% 10%;"> 
            ...
            <form id="updateForm" method="post" action="updatef.ho" enctype="multipart/form-data">
               <input type="hidden" name="housingNo" value="${ h.housingNo }">
               <table align="center">
                     <div class="form-group">
                        <label for="title">제목</label>
                        <input type="text" id="title" class="form-control" name="housingTitle" value="${ h.housingTitle }" required>
                    </div>
                     <div class="form-group">
                        <label for="writer">작성자</label>
                        <input type="text" id="writer" class="form-control" value="${ h.housingWriter }" readonly>
                    </div>
                    <div class="form-group">
                        <label for="upfile">첨부파일</label>
                        <input type="file" id="upfile" class="form-control-file border" name="reUploadFile">
                            <c:if test="${ !empty h.originName }">
	                                                               현재 업로드된 파일 : ${ h.originName } <br>
	                            <input type="hidden" name="changeName" value="${ h.changeName }">
	                            <input type="hidden" name="originName" value="${ h.originName }">
                            </c:if>
                    </div>
              		<div class="form-group">
                		<label for="housingcontent">내용 : </label>
                		<textarea class="form-control"  name="housingContent" id="housingContent" >${ h.housingContent }</textarea>
            		</div>      
            ...
            <script>
	           	 CKEDITOR.replace('housingContent');
            </script>
                <div align="center">
