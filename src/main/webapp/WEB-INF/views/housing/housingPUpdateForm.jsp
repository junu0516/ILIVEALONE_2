            ...
            <form id="updateForm" method="post" action="updateP.ho" enctype="multipart/form-data">
               ...
               <table align="center">
                     <div class="form-group">
                        ...
                        <input type="text" id="title" class="form-control" name="housingPTitle" value="${ hp.housingPTitle }" required>
                    </div>
                     <div class="form-group">
                        <label for="writer">작성자</label>
                        <input type="text" id="writer" class="form-control" value="${ hp.housingPWriter }" readonly>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="file" id="upfile" class="form-control-file border" name="reUploadFile">
                            <c:if test="${ !empty hp.housingPOriginName }">
	                                                               현재 업로드된 파일 : ${ hp.housingPOriginName } <br>
	                            <input type="hidden" name="housingPChangeName" value="${hp.housingPChangeName }">
	                            <input type="hidden" name="housingPOriginName" value="${hp.housingPOriginName }">
                            </c:if>
                    </div>
              		<div class="form-group">
                		<label for="housingPContent">내용 : </label>
                		<textarea class="form-control" required name="housingPContent" id="housingPContent" >${ hp.housingPContent }</textarea>
            		</div>      
				...
				<script>
				 	...
				 	CKEDITOR.replace('housingPContent');
