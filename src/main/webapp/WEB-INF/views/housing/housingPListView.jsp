  ...
  <div class="row content">
    <div class="col-sm-2 sidenav">
      <ul class = "list-group">
      	...
      	<a href="Toplist.ho" class="list-group-item list-group-item-success">하우징메인 페이지</a></p>
      	<a href="list.ho" class="list-group-item list-group-item-success">하우징게시물</a></p>
      	<a href="blist.ho" class="list-group-item list-group-item-success">하우징최신뉴스</a></p>
          ...
          <!-- 검색 기능  -->
			...
			<div class="container-fluid" id="cardArea">
				<c:forEach items="${list}" var="hp"> 
		        	...
		        	<div>
					<img class="card-img-top" src="${pageContext.request.contextPath}/resources/upload_files/${hp.housingPChangeName}" height="200px"/>
		        </div>
		        <div class="card-body">
