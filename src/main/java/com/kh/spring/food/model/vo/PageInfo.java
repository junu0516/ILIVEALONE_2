...
public class PageInfo {
	...
	public PageInfo(int currentPage, int listCount,int startPage, int endPage,  int maxPage, int pageLimit, int foodLimit) {
		super();
	...
	public String toString() {
		return "PageInfo [currentPage=" + currentPage + ", listCount=" + listCount + ", pageLimit=" + pageLimit
				+ ", maxPage=" + maxPage + ", startPage=" + startPage + ", endPage=" + endPage + ", foodLimit="
				+ foodLimit + "]";
	}
