...
public class PurchaseHistoryInterceptor extends HandlerInterceptorAdapter {

	private final Logger log = LoggerFactory.getLogger(PurchaseHistoryInterceptor.class);
