            ...
            <form id="updateForm" method="post" action="update.re" enctype="multipart/form-data">
                ...
                <tr>
                    ...
                    <select name="money_kind" id="setype">
                   		<c:if test="${ r.money_kind eq '월세' }">
	                    	<option value="none">---</option>
							<option value="월세" selected>월세</option>
							<option value="전세">전세</option>
						</c:if>
						<c:if test="${ r.money_kind eq '전세' }">
	                    	<option value="none">---</option>
                ...
                <tr>
                    <th width="100">면적</th>
                   <td><input type="text" id="area" value="${ r.area }" name="area" placeholder="ex)24.5" required>m²</td>
                </tr>
                <tr>
                    <th width="100">층</th>
                   <td><input type="text" id="floors" value="${ r.floors }" name="floors" placeholder="ex)2" required>층</td>
                </tr>
                <tr>
                    <th width="100">위치</th>
                   <td><input type="text" id="location" value="${ r.location }" name="location" placeholder="ex)서울시 강남구 테헤란로 51" required></td>
                </tr>
                <tr>
                ...
                <tr>
                    <th width="100">관리비</th>
                   <td><input type="text" id="admin" value="${ r.admin_money }" name="admin_money" placeholder="8" required></td>
                </tr>
                <tr>
                    <th width="100">구조</th>
                    <td colspan="3">
                ...
                <tr>
                   ...
                   <td><input type="text" id="entire_floors" value="${ r.entire_floors }" name="entire_floors" placeholder="5" required></td>
                </tr>
                <tr>
                    <th width="100">가격</th>
                   <td id="money">
                   		<input type= "text", name= "money1" value="${ r.money1 }" required>
                   		<input type= "text", name= "money2" value="${ r.money2 }" required>
                 ...
                 <tr>
                   ...
                   <td>
                   		<input type="text" id="phone" value="${ r.phone }" name="phone" placeholder="Please Enter Phone (-포함)"><br>
                   	</td>
                </tr>                
                 <tr>
                        <th><label for="upfile">매물 사진</label></th>
                        <td><input type="file" id="upfile" name="reUploadFile">
                        <c:if test="${ !empty r.originName }">
	                                                               현재 업로드된 파일 : ${ r.originName } <br>
